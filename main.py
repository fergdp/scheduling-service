...
from routers import oauth, appointments, waitlist, dentist_schedule, health as health_router
...
app.include_router(dentist_schedule.router, prefix="/clinic-scheduling-api/v1", tags=["Dentist Schedule"])
